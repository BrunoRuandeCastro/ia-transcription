...
//transformar em um campo na tela -> durante o envio do vídeo
const defaultTranscriptionPrompt = [
  `Esse vídeo faz parte de um curso sobre design de software utilizando Node.js e 
  conceitos de Domain-Driven Design. Algumas tecnologias e termos mencionados no
   vídeo são: JavaScript, TypeScript, WatchedList, Vitest e Aggregates.`,
].join('\n')

//transformar em um campo na tela -> pós carregar a transcricao
